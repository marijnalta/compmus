...
viz2 <- ggplot(tracks22, aes(x=valence, fill=playlist,
  ...
  guides(fill=guide_legend(title="Playlist"))+
  theme_minimal()+
  ggtitle("Distribution of valence 2019 (left) 2022 (right)")
...
viz2 <- ggplot(tracks22, aes(x=tempo, fill=playlist,
  ...
  guides(fill=guide_legend(title="Playlist"))+
  theme_minimal()+
  ggtitle("Distribution of tempo 2019 (left) 2022 (right)")
...
viz2 <- ggplot(tracks22, aes(x=danceability, fill=playlist,
  ...
  guides(fill=guide_legend(title="Playlist"))+
  theme_minimal()+
  ggtitle("Distribution of danceability 2019 (left) 2022 (right)")
...
viz2 <- ggplot(tracks22, aes(x=energy, fill=playlist,
  ...
  guides(fill=guide_legend(title="Playlist"))+
  theme_minimal()+
  ggtitle("Distribution of energy 2019 (left) 2022 (right)")
...
viz2 <- ggplot(tracks22, aes(x=loudness, fill=playlist,
  ...
  guides(fill=guide_legend(title="Playlist"))+
  theme_minimal()+
  ggtitle("Distribution of loudness 2019 (left) 2022 (right)")
